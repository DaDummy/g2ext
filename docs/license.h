 ...
 *
 * @section licence_bin Licence for G2Ext binaries and source code
 *
 *
 ...
 *
 *
 * @section licence_docs Licence for the G2Ext SDK documentation, API headers and examples
 *
 * THE WORK (AS DEFINED BELOW) IS PROVIDED
 * UNDER THE TERMS OF THIS CREATIVE COMMONS
 * PUBLIC LICENSE ("CCPL" OR "LICENSE").<br />
 * THE WORK IS PROTECTED BY COPYRIGHT AND/OR
 * OTHER APPLICABLE LAW. ANY USE OF THE WORK
 * OTHER THAN AS AUTHORIZED UNDER THIS LICENSE
 * OR COPYRIGHT LAW IS PROHIBITED.
 *	
 * Creative Commons Attribution-Noncommercial Alike 3.0 Unported.<br />
