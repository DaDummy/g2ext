...
private:
	char _data[0x58];
public:
	//.text:004D51F0 ; public: virtual int __thiscall zCInput_Win32::AnyKeyPressed(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D55D0 ; public: virtual void __thiscall zCInput_Win32::ClearKeyBuffer(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5320 ; public: float __thiscall zCInput_Win32::GetAutoRepeatDelayRate(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	*/
	...
	//.text:004D5370 ; public: virtual unsigned short __thiscall zCInput_Win32::GetKey(int, int)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5790 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedLeft(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D57A0 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedMid(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D57B0 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedRight(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5850 ; public: virtual void __thiscall zCInput_Win32::GetMouseFlipXY(int &, int &)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D4CA0 ; public: virtual int __thiscall zCInput_Win32::GetMouseIdle(void)const
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5730 ; public: virtual void __thiscall zCInput_Win32::GetMousePos(float &, float &, float &)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5810 ; public: virtual void __thiscall zCInput_Win32::GetMouseSensitivity(float &, float &)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D4D30 ; public: virtual float __thiscall zCInput_Win32::GetState(unsigned short)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5020 ; public: virtual int __thiscall zCInput_Win32::GetToggled(unsigned short)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D51C0 ; public: virtual int __thiscall zCInput_Win32::KeyPressed(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D51D0 ; public: virtual int __thiscall zCInput_Win32::KeyToggled(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5700 ; public: virtual void __thiscall zCInput_Win32::ProcessInputEvents(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5330 ; public: virtual void __thiscall zCInput_Win32::ResetRepeatKey(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D5300 ; public: void __thiscall zCInput_Win32::SetAutoRepeatDelayRate(float, float)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:004D4A00 ; public: void __thiscall zCInput_Win32::SetFocusWindow(struct HWND__ *)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	* @usable Ingame only
	*/
	void SetAutoRepeatDelayRate(zINT pA, zINT pB)
	{
		XCALL(0x004D54D0);
	};

	//.text:004D5830 ; public: virtual void __thiscall zCInput_Win32::SetMouseFlipXY(int, int)
	/** Insert description. 
	* @usable Ingame only
	*/
