...
__forceinline bits32 extractFloat32Frac( float32 a )
{
...
__forceinline int16 extractFloat32Exp( float32 a )
{
...
__forceinline flag extractFloat32Sign( float32 a )
{
...
__forceinline float32 packFloat32( flag zSign, int16 zExp, bits32 zSig )
{
...
__forceinline bits32 extractFloat64Frac1( float64 a )
{
...
__forceinline bits32 extractFloat64Frac0( float64 a )
{
...
__forceinline int16 extractFloat64Exp( float64 a )
{
...
__forceinline flag extractFloat64Sign( float64 a )
{
