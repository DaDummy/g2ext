...
private:
	char _data[0x58];
public:
	//.text:006624F0 ; public: virtual int __thiscall zCInput_Win32::AnyKeyPressed(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT AnyKeyPressed(void)
	{
		XCALL(0x006624F0);
	};

	//.text:006628D0 ; public: virtual void __thiscall zCInput_Win32::ClearKeyBuffer(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:00662620 ; public: float __thiscall zCInput_Win32::GetAutoRepeatDelayRate(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zFLOAT GetAutoRepeatDelayRate(void)
	{
		XCALL(0x00662620);
	};

	//.text:004D5510 ; public: virtual unsigned char __thiscall zCInput_Win32::GetChar(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zBYTE GetChar(void)
	...
	//.text:00662810 ; public: virtual unsigned short __thiscall zCInput_Win32::GetKey(int, int)
	/** Insert description. 
	* @usable Ingame only
	*/
	zBYTE GetChar(zINT pA, zINT pB)
	{
		XCALL(0x00662810);
	};

	//.text:00662A90 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedLeft(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT GetMouseButtonPressedLeft(void)
	{
		XCALL(0x00662A90);
	};

	//.text:00662AA0 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedMid(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT GetMouseButtonPressedMid(void)
	{
		XCALL(0x00662AA0);
	};

	//.text:00662AB0 ; public: virtual int __thiscall zCInput_Win32::GetMouseButtonPressedRight(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT GetMouseButtonPressedRight(void)
	{
		XCALL(0x00662AB0);
	};

	//.text:00662B50 ; public: virtual void __thiscall zCInput_Win32::GetMouseFlipXY(int &, int &)
	/** Insert description. 
	* @usable Ingame only
	*/
	void GetMouseFlipXY(zINT& pA, zINT& pB)
	{
		XCALL(0x00662B50);
	};

	//.text:00661FA0 ; public: virtual int __thiscall zCInput_Win32::GetMouseIdle(void)const
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT GetMouseIdle(void)
	{
		XCALL(0x00661FA0);
	};

	//.text:00662A30 ; public: virtual void __thiscall zCInput_Win32::GetMousePos(float &, float &, float &)
	/** Insert description. 
	* @usable Ingame only
	*/
	void GetMousePos(zFLOAT& pA, zFLOAT& pB, zFLOAT& pC)
	{
		XCALL(0x00662A30);
	};

	//.text:00662B10 ; public: virtual void __thiscall zCInput_Win32::GetMouseSensitivity(float &, float &)
	/** Insert description. 
	* @usable Ingame only
	*/
	void GetMouseSensitivity(zFLOAT& pA, zFLOAT& pB)
	{
		XCALL(0x00662B10);
	};

	//.text:00662030 ; public: virtual float __thiscall zCInput_Win32::GetState(unsigned short)
	/** Insert description. 
	* @usable Ingame only
	*/
	zFLOAT GetState(int pA)
	{
		XCALL(0x00662030);
	};

	//.text:00662320 ; public: virtual int __thiscall zCInput_Win32::GetToggled(unsigned short)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT GetToggled(int pA)
	{
		XCALL(0x00662320);
	};

	//.text:006624C0 ; public: virtual int __thiscall zCInput_Win32::KeyPressed(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT KeyPressed(zINT pA)
	{
		XCALL(0x006624C0);
	};

	//.text:006624D0 ; public: virtual int __thiscall zCInput_Win32::KeyToggled(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT KeyToggled(zINT pA)
	{
		XCALL(0x006624D0);
	};

	//.text:00662A00 ; public: virtual void __thiscall zCInput_Win32::ProcessInputEvents(void)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:00662630 ; public: virtual void __thiscall zCInput_Win32::ResetRepeatKey(int)
	/** Insert description. 
	* @usable Ingame only
	*/
	void ResetRepeatKey(zINT pA)
	{
		XCALL(0x00662630);
	};

	//.text:00662600 ; public: void __thiscall zCInput_Win32::SetAutoRepeatDelayRate(float, float)
	/** Insert description. 
	* @usable Ingame only
	*/
	void SetAutoRepeatDelayRate(zFLOAT pA, zFLOAT pB)
	{
		XCALL(0x00662600);
	};

	//.text:00661D00 ; public: void __thiscall zCInput_Win32::SetFocusWindow(struct HWND__ *)
	/** Insert description. 
	* @usable Ingame only
	*/
	void SetFocusWindow(HWND pA)
	{
		XCALL(0x00661D00);
	};

	//.text:00662B30 ; public: virtual void __thiscall zCInput_Win32::SetMouseFlipXY(int, int)
	/** Insert description. 
	* @usable Ingame only
	*/
	void SetMouseFlipXY(zINT pA, zINT pB)
	{
		XCALL(0x00662B30);
	};

	//.text:004D4E00 ; public: virtual int __thiscall zCInput_Win32::SetState(unsigned short, int)
	/** Insert description. 
	* @usable Ingame only
	*/
	zINT SetState(int pA, zINT pB)
	{
		XCALL(0x004D4E00);
	};

	//.text:006591A0 ; int __stdcall zCInput__BindOption(int, int, int, int, int, int, void *Memory, int, int)
	...
	*/
	...
	//.text:006594F0 ; public: int __thiscall zCInput::IsBinded(unsigned short, unsigned short)
	/** Insert description.
	* @usable Ingame only
	*/
	int IsBinded(LogicalKey logicalKey, zWORD key) // WTF?? Binded????? Bound!!!!
	{
		XCALL(0x006594F0)
	};

	//.text:006595F0 ; public: int __thiscall zCInput::IsBindedToggled(unsigned short, unsigned short)
	/** Insert description.
	* @usable Ingame only
	*/
	...
	//.text:00659750 ; public: unsigned short __thiscall zCInput::GetFirstBindedLogicalKey(unsigned short)
	/** Insert description.
	* @usable Ingame only
	*/
	...
	//.text:0065CEC0 ; public: void __thiscall zCInput::BindKeys(int)
	/** Insert description.
	* @usable Ingame only
	*/
	void BindKeys(int)
	...
	//.text:0065E690 ; public: static unsigned short __cdecl zCInput::GetControlValueByName(class zSTRING const &)
	/** Insert description.
	* @usable Ingame only
	*/
	...
	//.text:0065E740 ; public: static class zSTRING __cdecl zCInput::GetNameByControlValue(unsigned short)
	/** Insert description.
	* @usable Ingame only
	*/
	...
	//.text:006627D0 ; public: virtual void __thiscall zCInput_Win32::SetKey(int, int)
	/** Insert description. 
	* @usable Ingame only
	*/
	...
	//.text:00661D10 ; public: __thiscall zCInput_Win32::zCInput_Win32(struct HWND__ * *)
	/** Insert description. 
	* @usable Ingame only
	*/
	zCInput(HWND pA)
	...
	* @usable Ingame only
	*/
	inline static zCInput*	GetInput()		{ return *(zCInput**)0x009B74A8; };
};
